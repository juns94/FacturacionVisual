...
Public Class Search
    ...
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        sql = "select factura.idfactura,nombre,cliente.1erapell,cliente.2doapell, fecha from  factura, cliente,refraccion  where  refraccion.factura = factura.idFactura and factura.clienteId = cliente.idCliente " + getQuery() + ";"
    ...
    Protected Sub OnRowDataBound(sender As Object, e As GridViewRowEventArgs)
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            gvOrders.DataSource = GetData(String.Format("select * from detalle where factura ='{0}' ", idFactura))
            gvOrders.DataBind()
        End If
    End Sub
    ...
    Private Shared Function GetData(query As String) As DataTable
        Dim strConnString As String = "server=localhost;user id=admin;database=visualdesigns;persistsecurityinfo=True;password=admin"
