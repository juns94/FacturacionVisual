<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="DetallesRecibo.aspx.vb" Inherits="ASP_NET_WEB_APP.DetallesRecibo" %>
      ...
      <!--  <h5 class="display-4">Factura #</h5> -->
         ...
         <!-- TABLA DE CEDULA CLIENTE-->
          ...
          <div style="margin-left: 40px">
              <center> <h1>     &nbsp;</h1>
                  <h1>     &nbsp;</h1>
                  <h1>     Detalle de abonos   </h1></center>
              <br />
                  <asp:GridView ID="abonos" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#336666" BorderStyle="Double" BorderWidth="3px" CellPadding="4" CssClass="Grid" GridLines="Horizontal" Height="300px" HorizontalAlign="Center"  ShowFooter="True" Width="787px">
                      <Columns>
                                                  <asp:BoundField DataField="Fecha" HeaderText="Fecha" ItemStyle-Width="150px" />
                                                  <asp:BoundField DataField="MontoAbonado" HeaderText="MontoAbonado" ItemStyle-Width="150px" />
                                                  <asp:BoundField DataField="Tarjeta" HeaderText="Tarjeta" ItemStyle-Width="150px" />
