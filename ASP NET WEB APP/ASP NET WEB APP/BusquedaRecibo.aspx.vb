...
Public Class BusquedaRecibo
    ...
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        sql = "select recibo.idrecibo,nombre,cliente.1erapell,cliente.2doapell, recibo.fecha from  recibo,cliente  where cliente.cedula  = recibo.cedula and recibo.idrecibo = recibo.idrecibo " + getQuery() + ";"
    ...
    Public Function getQuery() As String
        ...
        If (factura.Text.Length > 0) Then temp += " and recibo.idrecibo= '" + factura.Text + "' "
  ...
  ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs)
        ...
        Session("recibo") = idFactura
        ' Add code here to add the item to the shopping cart.
        Response.Redirect("DetallesRecibo.aspx")
